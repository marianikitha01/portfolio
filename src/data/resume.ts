...
import { Briefcase, GraduationCap, Brain, Database, Code, Settings, TrendingUp, ShieldCheck, BarChart } from 'lucide-react';
...
export const resumeData: ResumeData = {
  ...
  skills: [
    ...
    { id: 'sk16', name: 'Communication', category: 'SoftSkills', icon: MessageSquare, proficiency: 90 },
